...
<% if (sp != null) { %>
    ...
    <div class="product-gallery">
        <img class="main-image"
             src="<%=request.getContextPath()%>/images/<%=sp.getDuongDanAnh()%>"
             alt="<%=sp.getTenSanPham()%>">
    </div>

    <div class="product-info">
        <h1 class="product-title"><%= sp.getTenSanPham() %></h1>

        <p class="product-status">
            Tình trạng: <span>Còn hàng</span>
        </p>

        <p class="product-statu">Mô tả ngắn:</p>
        ...
        <div class="product-price">
            <%= String.format("%,.0f", sp.getGia()) %>đ
        </div>

        <div class="product-note">
            <p>Giá chưa gồm chậu sứ hoặc bình thủy tinh</p>
            <p>
                Xem ảnh qua zalo HN Cầu Giấy
                <a href="tel:0972422110">0972 422 110</a>
            </p>
